...
import { viewCertificate } from "../../redux/slices/certificateSlice";
...
function CourseCertificate() {
  ...
  const { certificate, loading } = useSelector(
    (state: State) => state.certificate
  );
  const dispatch = useDispatch();
  useEffect(() => {
    dispatch(viewCertificate({ slug }));
  }, [dispatch, slug]);
